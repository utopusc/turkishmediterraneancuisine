...
$error = false;
$fields = array('persons','date-booking','time-booking','Occasion-booking','Requirement-booking','email','phone' );
...
if ( !$error ) {
	...
	$phone = stripslashes($_POST['Occasion-booking']);	
	$email = stripslashes($_POST['Requirement-booking']);
