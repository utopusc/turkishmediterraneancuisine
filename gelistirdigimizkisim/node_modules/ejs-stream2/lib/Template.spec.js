...
describe('Template', () => {
    it('should render as expected', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const readable = Template_1.render(`
<!DOCTYPE html>
<html>
...
<%= void 0 -%>
      ...
      `.trim(), {
            string: 'input-string',
            promise: utils_1.sleep(1).then(() => 'input-promise'),
            readable: utils_1.createReadable(2, 'input-readable-'),
        ...
        const chunks = yield utils_1.resolveReadable(readable);
