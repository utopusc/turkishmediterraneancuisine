...
class Template {
    ...
    compile() {
        ...
        try {
            fn = new ctor(LOCALS_NAME, 'escapeFn', 'AsyncReadableStream', this.source);
        }
        catch (e) {
        ...
        return (data) => {
            return fn(data || {}, escapeXML, AsyncReadableStream_1.AsyncReadableStream);
        };
    }
    generateSource() {
